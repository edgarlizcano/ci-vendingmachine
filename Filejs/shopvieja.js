...
var Shop = /** @class */ (function (_super) {
    ...
    function Shop(_principal) {
        ...
        _this.preparing_to_dispense = function (cb) {
            if (Global_1.default.Product_is == Global_1.default.Type_of_product.small) {
                _this.preparing_to_dispense_(Global_1.default.Time_down_to_dispensing_small, function (err) {
                    cb(err);
                });
            }
            else {
                _this.preparing_to_dispense_(Global_1.default.Time_down_to_dispensing_big, function (err) {
                    cb(err);
                });
            }
        };
        _this.preparing_to_dispense_ = function (time, cb) {
