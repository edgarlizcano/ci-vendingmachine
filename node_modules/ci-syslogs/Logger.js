...
var Logger = /** @class */ (function () {
    function Logger(ip, facility) {
        ...
        var createOptions = {
            transport: syslog_client_1["default"].Transport.Udp,
            port: 514
        };
        this.client = syslog_client_1["default"].createClient(ip, createOptions);
    ...
    Logger.prototype.LogDebug = function (message) {
        var logOptions = {
            ...
            severity: syslog_client_1["default"].Severity.Debug
        };
    ...
    Logger.prototype.LogInfo = function (message) {
        var logOptions = {
            facility: this.facility,
            severity: syslog_client_1["default"].Severity.Informational
        };
        this.client.log(message, logOptions, function (error) {
            if (error) {
                console.error(error);
    ...
    Logger.prototype.LogNotice = function (message) {
        var logOptions = {
            facility: this.facility,
            severity: syslog_client_1["default"].Severity.Notice
        };
        this.client.log(message, logOptions, function (error) {
            if (error) {
                console.error(error);
    ...
    Logger.prototype.LogWarning = function (message) {
        var logOptions = {
            facility: this.facility,
            severity: syslog_client_1["default"].Severity.Warning
        };
        this.client.log(message, logOptions, function (error) {
            if (error) {
                console.error(error);
    ...
    Logger.prototype.LogError = function (message) {
        var logOptions = {
            facility: this.facility,
            severity: syslog_client_1["default"].Severity.Error
        };
        this.client.log(message, logOptions, function (error) {
            if (error) {
                console.error(error);
    ...
    Logger.prototype.LogCritical = function (message) {
        var logOptions = {
            facility: this.facility,
            severity: syslog_client_1["default"].Severity.Critical
        };
        this.client.log(message, logOptions, function (error) {
            if (error) {
                console.error(error);
    ...
    Logger.prototype.LogAlert = function (message) {
        var logOptions = {
            facility: this.facility,
            severity: syslog_client_1["default"].Severity.Alert
        };
        this.client.log(message, logOptions, function (error) {
            if (error) {
                console.error(error);
    ...
    Logger.prototype.LogEmergency = function (message) {
        var logOptions = {
            facility: this.facility,
            severity: syslog_client_1["default"].Severity.Emergency
        };
        this.client.log(message, logOptions, function (error) {
            if (error) {
                console.error(error);
